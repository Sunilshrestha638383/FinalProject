...
public class AdapterChatList extends  RecyclerView.Adapter<AdapterChatList.MyHolder>{
    ...
    public AdapterChatList(Context context, List<ModelUsrs> userList) {
...
//            holder.lastMessageTv.setText("No message");
        ...
        try {
            ...
            Picasso.get().load(R.drawable.ic_default_image_green).into(holder.profileIv);
